...
void selectLayer2Page(byte page) __preserves_regs(b,c,d,e,h,iyh,iyl) __z88dk_fastcall;
void layer2StashPalette(byte *restrict buffer) __preserves_regs(iyh,iyl) __z88dk_fastcall;
void setFallbackColour(byte index) __preserves_regs(b,c,d,e,h,iyh,iyl) __z88dk_fastcall;
...
void updateSprite(struct sprite_info *restrict s) __preserves_regs(b,c,d,e) __z88dk_fastcall;
